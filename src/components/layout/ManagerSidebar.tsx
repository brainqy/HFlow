...
import { LayoutDashboard, Users, Settings as ClinicSettingsIcon, BarChart2, LogOut, ShieldAlert, FileText, Briefcase, UserCog as ProfileIcon, Eye, Image as ImageIcon } from 'lucide-react';
import { 
  Sidebar, 
  SidebarHeader, 
  SidebarContent, 
...
const managerNavItems = [
  ...
  { href: '/manager/homepage-hero', label: 'Manage Hero Slider', icon: ImageIcon, tooltip: 'Manage Hero Slider'},
