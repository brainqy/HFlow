  ...
  (
      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            side={side}
          >
            <div className="flex h-full w-full flex-col p-2 gap-2">{children}</div>
          </SheetContent>
        </Sheet>
      )
    }
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "duration-200 fixed top-16 z-10 hidden h-[calc(100svh-4rem)] w-[--sidebar-width] transition-[left,right,width] ease-linear md:flex",
            side === "left"
        ...
        >
          <div
            data-sidebar="sidebar"
            className="flex h-full w-full flex-col p-2 gap-2 bg-sidebar group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow"
          >
            {children}
          </div>
        </div>
